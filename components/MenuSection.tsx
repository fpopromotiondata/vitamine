...
export default function MenuSection() {
  return (
    <section id="menu" className="relative bg-brand-cream pt-16 lg:pt-20 overflow-hidden">
      ...
      {/* Bottom spacing — the wave that transitions into Reviews lives INSIDE
          ReviewsSection (as its top decoration) so it sits over the reviews'
          own mesh with no seam. We just need breathing room before it. */}
